    ...
    <main className="app-background auth-layout">
      <section className="auth-card" style={{ maxWidth: 560 }}>
        ...
        <p className="body-copy" style={{ marginTop: 0 }}>
          La red no esta disponible en este momento. Si ya habias iniciado sesion antes, vuelve a <strong>Operaciones</strong> y la app usara los datos locales para continuar.
        </p>
        <p className="body-copy" style={{ marginTop: 0 }}>
